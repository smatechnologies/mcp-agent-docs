...
description: "Set concurrency limits, job failure determination logic, task-completion messaging, checkpoint behavior, and temporary file location on the SMAVAR screen."
tags:
  - Reference
