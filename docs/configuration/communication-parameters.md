...
- Use this page when initially connecting the MCP Agent to an OpCon server to ensure the port number, hostname, and TLS settings match the corresponding values defined in the Enterprise Manager machine record.
