...
For more information, refer to [Automated Response](../additional-features/lsam-features/automated-response.md) to learn how to implement this feature.
...
For more information, refer to [Using *SMA/WFL/COMMAND](../additional-features/utilities/sma-wfl-command.md).
