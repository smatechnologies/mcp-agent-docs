...
To view the previous information, refer to [Dynamic LSAM Configuration](../../reference-information/legacy.md#dynamic-agent-configuration) in the Legacy Information topic.
