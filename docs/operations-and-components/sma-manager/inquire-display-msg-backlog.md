---
title: Inquire Display Msg Backlog (MSGCOUNT)
description: "View the current number of display messages queued for processing by the Display Handler to identify potential response delays."
tags:
  - Reference
  - Operations Staff
