# MCP Agent Documentation — Claude Code Project

This repository contains the OpCon MCP Agent product documentation site built with Docusaurus.
...
- **Terminology**: Use customer-facing terms. Never use: LSAM (in user-facing text), execute/executed/executing, right-select, click, drop-down, checkbox, navigate to, launch, client, task/process (as job synonyms)
